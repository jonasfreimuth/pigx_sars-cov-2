...
coverage.df <- fread(params$coverage_file) %>%
...
mut_cov.df <- data.frame(
  "Total number of tracked mutations" = coverage.df[1],
...
Coverage <- data.frame(
  "Number of aligned reads" = coverage.df[4],
...
write.csv2(coverage.df, file.path(
