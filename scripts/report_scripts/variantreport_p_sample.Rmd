...
params:
  sample_name: "file_150",
  output_dir: "/home/jfreige/pigx_pipeline_runs/UCSD_spike_in/output",
  vep_file: "/home/jfreige/pigx_pipeline_runs/UCSD_spike_in/output/variants/file_150_vep_sarscov2_parsed.txt",
  snv_file: "/home/jfreige/pigx_pipeline_runs/UCSD_spike_in/output/variants/file_150_snv.csv",
  sample_sheet: "/home/jfreige/pigx_pipeline_runs/UCSD_spike_in/sample_sheet_complete_bam.csv",
  mutation_sheet: "/home/jfreige/pigx_pipeline_runs/UCSD_spike_in/sample_data/mutation_sheet_ucsd_220309_t07.csv",
  deconvolution_functions: "/home/jfreige/.local/libexec/pigx_sars-cov-2/scripts/deconvolution.R",
  logo: "/home/jfreige/.local/share/pigx_sars-cov-2/Logo_PiGx.png"
---
...
for (i in all_mutations) {
  ...
  if (i_NT %in% complete.df$gene_mut) { # split gene name to match with AA mut
    ...
    if (i %in% colnames(output_mutation_frame)) {
      # unique necessary in case of vep errors. If the error leads to different
      # frequencies, this will still fail
      output_mutation_frame[, i] <- unique(
        complete.df$freq[which(complete.df$gene_mut == i_NT)]
        )
    }
  }
}
