...
```{r print_input_settings, echo = FALSE}
...
```{r function_parse_snv_csv, include = FALSE}
...
```{r process_signature_mutations, include = FALSE}
# Read signature data
...
```{r match_snvs_to_signature_mutations, include = FALSE}
...
```{r merge_vep_with_lofreq_info, include = FALSE}
...
```{r getting_unique_muts_bulk, include = FALSE}
...
```{r creating_signature_matrix, include = FALSE, eval = executeDeconvolution}
...
```{r calculate_sigmat_weigths, include = FALSE, eval = executeDeconvolution}
...
```{r simulating_WT_mutations, include = FALSE, eval = executeDeconvolution}
...
```{r deconvolution, include = FALSE, eval = executeDeconvolution}
source(deconvolution_functions)
...
```{r csv_output_variant_plot, include = FALSE, eval = executeDeconvolution}
...
```{r csv_output_mutation_plot, include = FALSE}
